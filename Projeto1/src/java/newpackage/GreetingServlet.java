...
public class GreetingServlet extends HttpServlet {    
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DateTimeFormatter dataHora = DateTimeFormatter.ofPattern("HH:mm:ss");
            LocalDateTime data = LocalDateTime.now();
            String trueData = data.format(novaData); 
            String trueDataHora = data.format(dataHora); 
            out.println("Data: " + trueData); 
            out.println("<br>");
            out.println("Hora: " + trueDataHora); 
            out.println("<br>");
